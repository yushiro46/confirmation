...
var currentId = null; // 今開いている行のIDを保持

var safeParse = function safeParse(v) {
...
deleteBtn === null || deleteBtn === void 0 || deleteBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
  var res, json, _tr$parentNode, tr, _t;
  return _regenerator().w(function (_context) {
    while (1) switch (_context.p = _context.n) {
      ...
      case 2:
        _context.p = 2;
        _context.n = 3;
        return fetch("/contacts/".concat(currentId), {
          method: 'DELETE',
          headers: {
      ...
      case 5:
        ...
        if (json.ok) {
          // 行をDOMから削除
          tr = document.querySelector("tr[data-row-id=\"".concat(currentId, "\"]"));
          tr === null || tr === void 0 || (_tr$parentNode = tr.parentNode) === null || _tr$parentNode === void 0 || _tr$parentNode.removeChild(tr);
